...
const card = [
  ...
  {
    img: "/assets/img/blog/10-Information-Technology-Audit-Report-Samples-Templates-PDF-Word.jpg",
  ...
  {
    img: "/assets/img/blog/about-1.jpg",
    topText:
  ...
  {
    img: "/assets/img/blog/banner-finance.jpg",
  ...
  {
    img: "/assets/img/blog/banner2.jpg",
  ...
  {
    img: "/assets/img/blog/Recruitment-Agency-in-India.jpg",
  ...
  {
    img: "/assets/img/blog/Requirement.png",
    topText:
      " Are Recruitment Agencies Helpful To Get A Job In Information Technology?",
    bottomText:
  ...
  {
    img: "/assets/img/blog/service-detail.jpg",
      ...
      <div>
        ...
        <div className="flex px-14 gap-4 flex-wrap justify-center py-20 ">
          {card.map((d, i) => (
            ...
            >
              <div className="">
                <img className="rounded-lg h-52 w-full object-cover" src={d.img} />
              </div>
        ...
        <div className="flex items-center text-center py-8 px-3 flex-col bg-indigo-900 text-white hover:bg-red-600 transition-all duration-700">
          ...
          <p>We're here to help. Send us an email or call us at 4798020192</p>
        </div>
      </div>
      <Footer />
    </div>
