...
const Nabbar = () => {
  ...
  return (
    <header className={`fixed top-0 w-full z-50 transition duration-300 ${isAtTop ? "bg-transparent" : "bg-cyan-500"}`}>
      <div className="flex items-center justify-between px-4 sm:px-12 py-3">
        <Link to="/">
          <img src="/Main-Logo.png" alt="Logo" className="h-12 sm:h-16" />
        </Link>
